...
const menuSections = [
  ...
  { id: 'sp-sweetcorn', title: 'Sweet Corn Soup (Veg)',price:"14/160", variants: [
          { suffix: 'Veg', price: 140 },
          { suffix: 'Chicken', price: 160 }
        ], desc: 'Creamy light corn blend with assorted vegetables/chicken.' },
  { id: 'sp-hot&sour', title:'Hot & Sour Soup',price:"14/160", variants: [
          { suffix: 'Veg', price: 140 },
          { suffix: 'Chicken', price: 160 }
        ], desc: 'Mixed vegetable/chicken in a spicy soya-based soup.' },
  { id: 'sp-Manchow', title: 'Manchow Soup',price:"14/160", variants: [
          { suffix: 'Veg', price: 140 },
          { suffix: 'Chicken', price: 160 }
        ], desc: 'Thick vegetable/chicken soup served along crispy fried noodles.' },
  { id: 'sp-Tomato/Mushroom/Vegetable', title: 'Cream of Tomato/Mushroom/Vegetable',price:"14/160", variants: [
          { suffix: 'Veg', price: 140 },
          { suffix: 'Chicken', price: 160 }
